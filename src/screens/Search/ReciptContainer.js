...
import Recipt from '../../components/Order_UI/OrderConfirmRecipt'
      ...
      console.log('props ', this.props)
        return(
            ...
            <Header hasTabs style={styles.header} androidStatusBarColor='black' backgroundColor='black'>
              <Left>
                <Button transparent onPress={() => this.props.navigation.pop(3)}>
            ...
            <Recipt navigation={this.props.navigation}/>
          </Container>    
        )
    }
}
