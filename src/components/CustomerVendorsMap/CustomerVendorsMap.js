...
class CustomerVendorsMap extends Component{
...
(HINT: Check your GPS Connection in the device!)
    ...
    render(){
        ...
        if(this.state.shareLocation){
            ...
            <Icon name="bullhorn" size={20} color="#fff" style={styles.iconStyle}/>
            <Text style={styles.textStyle}>Notify Vendors</Text>
            </Button>
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerVendorsMap); 